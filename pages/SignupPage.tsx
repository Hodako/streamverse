...
export default function SignupPage() {
  ...
  const nameError = touched.name && !name ? 'Name is required' : touched.name && name.length < 2 ? 'Name must be at least 2 characters' : null;
    ...
    <div className="min-h-[calc(100vh-56px)] flex items-center justify-center p-4 bg-gradient-to-br from-yt-black via-yt-black to-[#1a0a0a]">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-yt-textSec">Join StreamTube to start watching</p>
        </div>
          ...
          <form onSubmit={onSubmit} className="space-y-5">
            ...
            <div>
              ...
              <div className="relative">
                <User className="absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5 text-yt-textSec" />
                <input
                  value={name}
                  ...
                  className={`w-full bg-[#121212] border ${
                    nameError ? 'border-red-500/50' : 'border-white/10 focus:border-white/30'
            ...
            <div>
              ...
              {password && !passwordError && (
                <div className="mt-2">
                  ...
                  <p className="text-xs text-yt-textSec">Use 8+ characters with uppercase, numbers</p>
                </div>
              )}
            </div>
